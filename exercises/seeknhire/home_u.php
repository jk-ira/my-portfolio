...
<body>
	...
	<div class="row mt-2">
		...
		<div class="side-bar col-4 col-lg-3">
			<center>
				<div class="prof-pic">
					<?php
					//check if profile pic is uploaded on db
					$sql = "SELECT * FROM job_seekers WHERE email = '$email'";
					$run = mysqli_query($connection,$sql);
					$row = mysqli_fetch_assoc($run);
					if ($row['profile_picture'] == ""){
						//if no pp uploaded yet, load default pp
						echo "<a href='img/profile/default.jpg'><img src='img/profile/default.jpg'></a>";
					}
					else{
						//if pp uploaded
						echo "<a href='img/profile/".$row['profile_picture']."'><img src='img/profile/".$row['profile_picture']."'></a>";
					}
				...
				<a <?php if($curr == 'profile_pic') echo "class='curr'";?>href="./home_u.php?curr=profile_pic"><i class="fas fa-pen"></i></a>
				<div class="names">
	...
	<!-- right part Content -->
		<div class="right-part col-8 col-lg-9">
			<?php
				//load profile pic
				if($curr == 'profile_pic') include('./includes/update_profile_pic.php');
